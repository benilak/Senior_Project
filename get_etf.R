...
# get etf url from industry url
etf_url = "https://eresearch.fidelity.com/eresearch/markets_sectors/sectors/industries.jhtml?tab=learn&industry=255040" %>%
    str_replace("learn", "investments") %>%
    paste0("&topic=etf")
}
